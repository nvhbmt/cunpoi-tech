...
const vi: Content = {
    ...
    contact: {
        ...
        body: 'Tôi đang làm toàn thời gian tại HDC Flowtech nên chỉ nhận thêm việc bán thời gian hoặc freelance — thường là một mảng frontend, một service backend, hoặc trọn gói một sản phẩm nhỏ. Bạn cứ gửi phạm vi công việc và thời hạn, tôi trả lời trong ngày.',
...
const en: Content = {
    ...
    contact: {
        ...
        body: 'I work full-time at HDC Flowtech, so I only take on part-time or freelance work — usually a frontend slice, a backend service, or a small product end to end. Send me the scope and the timeline; I reply the same day.',
